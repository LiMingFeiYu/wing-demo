...
public class AepSoftwareManagementDemo {
	...
	public void testApiInSandbox() throws Exception {
		...
		AepSoftwareManagementClient client = AepSoftwareManagementClient.newClient().sandbox(true).build();
	...
	public void testApiWithSslInSandbox() throws Exception {
		...
		AepSoftwareManagementClient client = AepSoftwareManagementClient.newClient().scheme(Scheme.HTTPS).sandbox(true).build();
