...
public class AepSoftwareUpgradeManagementDemo {
	...
	public void testApiInSandbox() throws Exception {
		...
		AepSoftwareUpgradeManagementClient client = AepSoftwareUpgradeManagementClient.newClient().sandbox(true).build();
	...
	public void testApiWithSslInSandbox() throws Exception {
		...
		AepSoftwareUpgradeManagementClient client = AepSoftwareUpgradeManagementClient.newClient().scheme(Scheme.HTTPS).sandbox(true).build();
