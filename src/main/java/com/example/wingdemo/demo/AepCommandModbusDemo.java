...
public class AepCommandModbusDemo {
	...
	public void testApiInSandbox() throws Exception {
		...
		AepCommandModbusClient client = AepCommandModbusClient.newClient().sandbox(true).build();
	...
	public void testApiWithSslInSandbox() throws Exception {
		...
		AepCommandModbusClient client = AepCommandModbusClient.newClient().scheme(Scheme.HTTPS).sandbox(true).build();
